...
<form class="form-horizontal" method="post" action="{{ URL::to('user/' . $user->id . '/edit') }}"  autocomplete="off">
    ...
    <div class="tab-pane active" id="tab-general">
        ...
        <div class="form-group {{{ $errors->has('first_name') ? 'error' : '' }}}">
            <label class="col-md-2 control-label" for="email">Full Name</label>
            <div class="col-md-10">
                <input class="form-control" type="text" name="email" id="email" value="{{{ Input::old('first_name', $user->first_name) }}} {{{ Input::old('last_name', $user->last_name) }}}" />
            </div>
        </div></fieldset>
